...
import { registerUser, loginUser } from "@/app/config/redux/action/authAction"
import { reset, emptyMessage } from "@/app/config/redux/reducer/authReducer"
...
function LoginComponent() {
    ...
    }, [authState.loggedIn]) // ✅ dependency array
            ...
            <div className={styles.cardContainer}>
                <div className={styles.cardContainer_left}>
                  ...
                  <p style={{color: authState.isError ? "red": "green"}}>
                          {authState.message?.message || authState.message}</p>   
